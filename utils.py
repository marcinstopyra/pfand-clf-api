...
def crop_image(img, new_size=200):
...
def resize_image(img, resize_factor=0.1):    
...
def preprocess_images(load_dir, save_dir, ready_dir, resize_factor=0.1, new_size=200, grayscale=False):
...
def preprocess_image(img, resize_factor=0.1, new_size=200, grayscale=False):
